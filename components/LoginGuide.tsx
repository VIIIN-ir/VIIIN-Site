...
import { loginGuideContent } from '../content/loginGuideContent';
  ...
  return (
    <div className="space-y-8">
      <div className="text-center space-y-3">
        ...
        <h1 className="text-3xl sm:text-4xl font-extrabold text-white">{loginGuideContent.title}</h1>
        <p className="text-slate-300 max-w-2xl mx-auto">{loginGuideContent.subtitle}</p>
      </div>

      <div className="grid gap-6">
        {loginGuideContent.sections.map((section) => (
                ...
                <li key={step.title} className="rounded-xl border border-white/10 bg-black/20 p-4">
                  ...
                  {step.imageUrl && (
                    <img
                      ...
                      className="mt-4 w-full max-h-80 object-contain rounded-xl border border-white/10 bg-black/20 p-2"
                      loading="lazy"
                    />
                  )}
